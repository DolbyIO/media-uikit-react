const { rootFormatter, fileHeaderFactory } = require('./src/utils/format.utils');
const { filterByCategoryFactory, filterByTypeFactory } = require('./src/utils/filter.utils');
    ...
    scss: {
      ...
      files: [
        ...
        },
        {
          ...
          filter: filterByTypeFactory(TokenTypes.Gradient),
          options: {
            fileHeader: fileHeaderFactory(TokenCategories.Color, TokenTypes.Gradient),
          },
        },
      ],
    },
